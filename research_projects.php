...
<div class="form-container">
    <h2>Request Grant Access to Research project</h2>
    <form action="submit_request.php" method="POST">
        ...
        <div class="input-group">
            <label for="rsup_name">Research Supervisor Name</label>
            <input type="rsup_name" id="rsup_name" name="rsup_name" required>
        </div>
        <div class="input-group">
