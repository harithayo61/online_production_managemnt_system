...
<div class="form-container">
    <h2>Request Access to plan an Event</h2>
    <form action="submit_request.php" method="POST">
        ...
        <div class="input-group">
            ...
            <input type="eventdate" id="eventdate" name="eventdate" required>
        </div>
        <div class="input-group">
            <label for="eventvenue">Event Venue</label>
            <input type="eventvenue" id="eventvenue" name="eventvenue" required>
        </div>
        <div class="input-group">
